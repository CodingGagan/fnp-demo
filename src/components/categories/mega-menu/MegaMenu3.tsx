  ...
  return categories ? (
    <StyledMegaMenu1 className="mega-menu">
      <Card ml="1rem" minWidth={minWidth} boxShadow="regular">
              ...
              <a>
                <Box position="relative" width="153px" height="100%">
                  {/* <NextImage
                    ...
                    objectFit="contain"
                  /> */}
        <img src={rightImage.imgUrl} style={{objectFit: 'contain', height: '52px', width: '52px'}} />
        ...
        <img src={"http://sendmyfeelings.thesoftwarecompany.in/assets/images/products/paper-bag.png"} style={{objectFit: 'contain', height: '100%', width: '100%'}} />
